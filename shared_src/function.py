...
import sentry_sdk
from sentry_sdk import capture_event, capture_exception, add_breadcrumb, capture_message, push_scope
...
def function(f):
    ...
    def wrapper(*args, **kwargs):
        with push_scope() as scope:
            try:
                scope.set_tag("function", f.__name__)
                global requestnum
                requestnum += 1
                scope.set_tag("requestnum", requestnum)
